...
const data = [
  {
    ...
    imgUrl: "https://res.cloudinary.com/dboy04n6m/image/upload/v1673379890/cs_qn73iw.jpg"
  },
  {
    name: "Tradepoint",
    content: "The contest by the name 'TradePoint' would be a 5-day live event where you'd be given some virtual money to create your own portfolio. This is a golden chance for all the finance pundits to showcase their trading skills. The portfolio with the highest profit would be declared the winner.",
    contact: "Asit Desai",
    ...
    imgUrl: "https://res.cloudinary.com/dboy04n6m/image/upload/v1673381486/tp_zj7nwz.jpg"
  },
  {
    name: "E-PIC",
    content: "Is persuasion your forte? Do you have the knack to convert a 90-second elevator ride into a profitable investment? Look no further! E-Cell IIT Hyderabad presents you with the “Elevator Pitch”, where you can pitch your business ideas briefly yet impress potential investors.",
    contact: "Sneha Chilukuri",
    number: "+91 79936 59092",
    email: "me21mtech14002@iith.ac.in",
    link: "None",
    imgUrl:"https://res.cloudinary.com/dboy04n6m/image/upload/v1673381792/epic_yux10a.png"
  },
  {
    name: "Big-Quiz",
    content: "The objective of this event is to quiz participants on various trends and current affairs in the Business World, further, helping develop an interest in the same.Well, here's your chance! E-Cell IIT Hyderabad brings you 'Biz-Quiz'. Participants have to showcase their knowledge and understanding of business concepts and win exciting prizes.",
  ...
  },
  {
    ...
    imgUrl:"https://res.cloudinary.com/dboy04n6m/image/upload/v1673382014/i_uqx457.png"
  },
  {
    name: "Pitch Showdown",
    content: "In this competition, participants will pitch on startup/business ideas that we give them and debate other teams ideas with their creativity and spontaneity being the criteria for evaluation.Well, here's your chance! E-Cell IIT Hyderabad brings you 'Pitch Showdown'. Participants have to showcase their startup ideas in order to get expert advice from the judges and win exciting prizes.",
  ...
  },
  {
    ...
    imgUrl:"https://res.cloudinary.com/dboy04n6m/image/upload/v1673382449/fr_kfwpmu.jpg"
  },
  {
    name: "Beyond Horizon",
    content: "Beyond Horizon is the competition for all of the solutionists out there who want to test their tact in real life scenarios .The competition checks how you pickup the nuanced effect of complex political scenarios from the given data.",
    ...
    imgUrl:"https://res.cloudinary.com/dboy04n6m/image/upload/v1673382371/bh_bdvpwc.jpg"
  }
];
