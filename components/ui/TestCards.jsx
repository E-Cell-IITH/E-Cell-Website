...
const cardsData = [
    {
        ...
        name: (
            <>
              ...
              These sessions bring together thought leaders and industry experts to 
              address real-world challenges, share insights, and explore collaborative solutions.
            </>
          ),
...
const TestCards = () => {
    return (
        ...
        <div className="h-[30rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
            <h2 className="text-4xl font-bold text-white text-center mb-8 z-10">Highlights of 
                E-Merge 2.0
            </h2>
